...
class BlackCard(MongoDocument):
    ...
    # Init
    # ---------------------------------------------------------------------------------------------
    def __init__(self, mongo_client, mongo_session, document_id=None):
        super(BlackCard, self).__init__(mongo_client, mongo_session)
        if document_id:
...
class WhiteCard(MongoDocument):
    ...
    # ---------------------------------------------------------------------------------------------
    def __init__(self, mongo_client, mongo_session, document_id=None):
        super(WhiteCard, self).__init__(mongo_client, mongo_session)
        if document_id:
            self.get(document_id)
